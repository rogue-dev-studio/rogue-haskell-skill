...
Haskell with GHC, Cabal, Stack, and HLS. Use when the project needs this capability or the user / team manifest asks for it.

## When to use

- `TEAM.yaml` includes `haskell` or user asks by name
...
2. **Confirm tooling** - Verify `haskell` runtime/CLI/MCP is available; document install if missing.
